...
namespace LanguageLibrary
{
    public class WordList
    {
        ...
        {
            if (!File.Exists(Folder.GetFilePath(name)))
            {
                return null;
            } 
        ...
        {
            if (_words.All(i => i.Translations[translation] != word.ToLower()))
            {
                return false;
            }
        ...
        public void List(int sortByTranslation, Action<string[]> showTranslations)
        {
            ...
            LoadList(Name);
            foreach (var translation in sortedList) 
            {
